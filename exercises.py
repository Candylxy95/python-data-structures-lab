...
def manage_students():
    students_list = ['alex','owen','sandy']
    first_student = students_list[1]
    last_student = students_list[-1]
    return f'Student list: {students_list}, First student: {first_student}, Last student: {last_student}'
...
def slice_foods():
    ...
    return f'Last two food: {last_two_foods}'
